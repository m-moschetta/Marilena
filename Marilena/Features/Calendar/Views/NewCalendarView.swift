...
/// Vista principale del nuovo calendario con gesture simultanee
public struct NewCalendarView: View {
    ...
    public var body: some View {
        ...
        // Gesture simultanea principale per swipe orizzontale
        .simultaneousGesture(
            DragGesture(minimumDistance: 50)
                .onEnded { value in
                    ...
                    // Solo se il movimento è principalmente orizzontale con velocità o distanza sufficiente
                    let isHorizontal = abs(horizontalAmount) > abs(verticalAmount) * 1.5
                    let isFastSwipe = abs(velocity) > 80
                    let isLongSwipe = abs(horizontalAmount) > 60
